...
<head>
  ...
  <link src="assets/img/avatars/1.png" rel="stylesheet">
  <style>
    body {
      padding-top: 56px;
    }
...
{{--        <img src="" >--}}
        <span class="app-brand-logo demo">
          ...
          @else
            <img src="{{asset('assets/img/github.png')}}" alt="Brand Logo" style="width:60px; height: 50px" class="img-fluid">
          @endif
         </span>
      </a>a
      ...
      <div class="col-lg-8">
        ...
        <!-- Preview Image -->
          @if(isset($posts->image))
            <img src="{{ asset('uploads/profile_pic/'.$posts->image) }}" alt="Profile Pic 1 " class="card-img-top"{{--style="width: 550px;margin: auto;"--}}>
          @else
